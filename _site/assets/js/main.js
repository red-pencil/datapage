...
(function() {
  var i18n = {
    zh: {
      ...
      productNames: "高质量第一人称数据",
      // productDesc: "专为物理 AI 训练打造",
      productDesc: "专为具身智能训练打造",
      featuresTitle: "我们的特色",
      feature1Title: "数据采集",
      // feature1Item1: "多协议支持",
      feature1Item1: "定制化采集",
      // feature1Item2: "实时采集",
      feature1Item2: "多场景采集网络",
      // feature1Item3: "边缘计算",
      feature1Item3: "标准化采集流程",
      feature2Title: "智能处理",
      // feature2Item1: "AI 分析",
      feature2Item1: "专有数据管线",
      // feature2Item2: "自动分类",
      feature2Item2: "自动切分标注",
      // feature2Item3: "模式识别",
      feature2Item3: "AI+人工质检",
      // feature3Title: "安全",
      feature3Title: "安全交付",
      feature3Item1: "端到端加密",
      feature3Item2: "访问控制",
      ...
      backToHome: "返回",
      teamTitle: "我们的团队",
      teamDesc: "团队成员来自机器人实验室、互联网、咨询和投行。兼具机器人行业理解、规模化执行与商业落地能力。",
      contact: "联系我们",
      footerEmail: "becky@rdv.bot",
      footerPhone: "+1 234 567 890",
      footerAddress: "美国加利福尼亚州旧金山",
      footerCopyright: "© 2026 RDV. 保留所有权利。",
    ...
    en: {
      ...
      productNames: "High Quality Egocentric Data, Ready For Use",
      productDesc: "Crafted for Physical AI Training",
      featuresTitle: "Our Feature",
      feature1Title: "Data Collection",
      product1Desc: "Efficiently collect egocentric data with multi-protocol support",
      // feature1Item1: "Multi-protocol Support",
      feature1Item1: "Tailored to model",
      // feature1Item2: "Real-time Collection",
      feature1Item2: "Distributed collector network",
      // feature1Item3: "Edge Computing",
      feature1Item3: "Standard collection procedure",
      feature2Title: "Smart Processing",
      // feature2Item1: "AI Analytics",
      feature2Item1: "Proven data pipeline",
      // feature2Item2: "Auto Classification",
      feature2Item2: "Segmented and annotated",
      // feature2Item3: "Pattern Recognition",
      feature2Item3: "Quailty assurance by AI and human",
      ...
      backToHome: "Back",
      teamTitle: "Our Team",
      teamDesc: "Born from physical AI labs, seasoned in consulting, tech and banking. We marry expertise in tech and industry with focus on product pipleine and delivery of complex project",
      contact: "Contact",
      footerEmail: "becky@rdv.bot",
      footerPhone: "+1 234 567 890",
      footerAddress: "San Francisco, CA, USA",
      footerCopyright: "© 2026 RDV. All rights reserved.",
