...
(function() {
  var i18n = {
    zh: {
      ...
      cta: "了解更多",
      productsTitle: "我们的产品",
      product1Title: " EgoCentric 数据",
      product1Desc: "专为物理 AI 训练打造",
      product2Title: "动作捕捉",
      product2Desc: "高精度人形机器人数据采集",
      product3Title: "Sim-to-Real",
      product3Desc: "连接仿真与现实部署",
      featuresTitle: "我们的特色",
      feature1Title: "数据采集",
      feature1Item1: "多协议支持",
      feature1Item2: "实时采集",
    ...
    en: {
      ...
      product1Title: "Egocentric Data",
      product1Desc: "Crafted for Physical AI Training",
      product2Title: "Motion Capture",
      product2Desc: "High-precision humanoid robot data collection",
      product3Title: "Sim-to-Real",
      product3Desc: "Bridging simulation and real-world deployment",
